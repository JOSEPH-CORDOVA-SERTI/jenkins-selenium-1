...
public class PantallaVentaDispositivoFuncionalPL extends Base {
	...
	public void limpiarCampos() throws InterruptedException {
		Thread.sleep(5000);
		WebDriverWait ewait = new WebDriverWait(navegador, Duration.ofSeconds(100));
		ewait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.id("navbarDropdownMenuLink")));
	...
	public void ventaDisValeras() {
		...
		String mensajeExitoso = VentaManual.ventaExitosa().getText();
		Assert.assertTrue((mensajeExitoso.contains("La transacción ha sido aprobada")));
		VentaManual.ventaExitosa().click();
