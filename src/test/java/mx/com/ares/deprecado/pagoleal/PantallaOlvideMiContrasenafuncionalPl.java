...
public class PantallaOlvideMiContrasenafuncionalPl extends Base {
	...
	public void EnvioExitoso() throws InterruptedException {
		...
		WebDriverWait ewait = new WebDriverWait(navegador, Duration.ofSeconds(10));
		ewait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"MainContent_lblSuccess2\"]")));
		String mensajeExitoso = navegador.findElement(By.xpath("//*[@id=\"MainContent_lblSuccess2\"]")).getText();
