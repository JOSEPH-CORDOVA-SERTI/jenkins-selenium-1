...
public class PantallaRegistroDisenoF  extends Base {
	...
	public void openBrowser() {
		navegador.get("https://feenicia.net/Fnza_SSO/User/PreRegistro");		
	}
	...
	public void mensajeIniciarSesion() throws Exception {
		String NuevoRegistro = navegador.findElement(By.xpath("//*[@id=\"form1\"]/div[3]/div/div/div/h2")).getText();
	...
	public void mensajeRegistro() throws Exception {
		String MensajeYCrearegistro = navegador.findElement(By.xpath("//*[@id=\"form1\"]/div[3]/div/div/div/p[1]")).getText();
	...
	public void correo() throws Exception {
		String correo = navegador.findElement(By.xpath("//*[@id=\"form1\"]/div[3]/div/div/div/div[2]/label")).getText();
	...
	public void usuario() throws Exception {
		String usuario = navegador.findElement(By.xpath("//*[@id=\"form1\"]/div[3]/div/div/div/div[3]/label")).getText();
	...
	public void caracteresContrasena() throws Exception {
		String contrasena = navegador.findElement(By.xpath("//*[@id=\"helpBlock\"]")).getText();
